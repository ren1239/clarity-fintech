...
export default async function DashboardPage() {
  ...
  //Make an API call for historic data for each ticker symbol, because the results could be null within the array, we need to filter tham out
  ...
  const priceByDate: { [key: string]: { [key: string]: number } } = {};
  ...
  const marketValueArray: number[] = portfolioDbData.map((stock) => {
